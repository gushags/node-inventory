...
--  furn_name               | wood_name |  ftype_name   |   collection_name    |  finv_sku  | finv_quantity
-- -------------------------+-----------+---------------+----------------------+------------+---------------
--  Bill Gorton Chair       | Birch     | Chair         | Hemingway Collection | BGC-Birch  |            30
--  Bill Gorton Chair       | Cherry    | Chair         | Hemingway Collection | BGC-Cherry |            40
--  Bill Gorton Chair       | Oak       | Chair         | Hemingway Collection | BGC-Oak    |            40
--  Bill Gorton Chair       | Walnut    | Chair         | Hemingway Collection | BGC-Walnut |            40
--  Jake Barnes Table       | Birch     | Kitchen Table | Hemingway Collection | JBT-Birch  |             5
--  Jake Barnes Table       | Cherry    | Kitchen Table | Hemingway Collection | JBT-Cherry |             7
--  Jake Barnes Table       | Oak       | Kitchen Table | Hemingway Collection | JBT-Oak    |             4
--  Jake Barnes Table       | Walnut    | Kitchen Table | Hemingway Collection | JBT-Walnut |             3
--  Robert Cohn Hutch       | Birch     | Hutch         | Hemingway Collection | RCH-Birch  |             2
--  Robert Cohn Hutch       | Cherry    | Hutch         | Hemingway Collection | RCH-Cherry |             3
--  Robert Cohn Hutch       | Oak       | Hutch         | Hemingway Collection | RCH-Oak    |             0
--  Robert Cohn Hutch       | Walnut    | Hutch         | Hemingway Collection | RCH-Walnut |             1
-- plus many more rows...

-- Query to get table only with Hemingway collection
SELECT furn_name, wood_name, ftype_name, collection_name, finv_sku, finv_quantity FROM furniture_inventory
    ...
    JOIN collections
        ON collections.collection_id = furniture_inventory.collection_id
    WHERE collection_name = 'Hemingway Collection';

-- Query to get table only with Hemingway collection AND walnut wood
SELECT furn_name, wood_name, ftype_name, collection_name, finv_sku, finv_quantity FROM furniture_inventory
    JOIN furniture
        ON furniture.furn_id = furniture_inventory.furn_id
    JOIN wood
...
--  Jake Barnes Table       | Walnut    | Kitchen Table | Hemingway Collection | JBT-Walnut |             3
--  Robert Cohn Hutch       | Walnut    | Hutch         | Hemingway Collection | RCH-Walnut |             1
--  Pamplona Deckchair      | Walnut    | Deckchair     | Hemingway Collection | PD-Walnut  |            11
--  Pedro Romero Bench      | Walnut    | Bench         | Hemingway Collection | PRB-Walnut |            17
--  San Sebastien Bed       | Walnut    | Bed           | Hemingway Collection | ssb-Walnut |             2
--  Brett Ashley Headboard  | Walnut    | Headboard     | Hemingway Collection | SSB-Walnut |             2
--  Cafe Side Table         | Walnut    | Side Table    | Hemingway Collection | CST-Walnut |             0
